...
const DashboardInfoEdit = ({isDrawerEditOpen,toggleEditDrawer, countries, selectedCountry, setSelectedCountry}) => {
  return (
    <div>
      {isDrawerEditOpen && (
        <div
...
<div
        className={`fixed top-0 right-0 h-full w-full lg:w-[600px] bg-white z-20 transform ${
          isDrawerEditOpen ? "translate-x-0" : "translate-x-full"
        } transition-transform duration-300 shadow-lg`}
      >
        <div className="pt-[72px] px-6  md:px-[48px] relative">
          <h2 className="text-[24px] mb-4 md:mb-12 font-bold">Edit Address</h2>
          <form className="flex flex-col gap-3">
            ...
            <p className=' text-red-800 cursor-pointer pt-2'>Delete Address</p>
...
export default DashboardInfoEdit